...
export function getProperties(_values: EventBackgroundPreviewProps, defaultProperties: Properties/*, target: Platform*/): Properties {
...
// export function getPreview(values: EventBackgroundPreviewProps, isDarkMode: boolean, version: number[]): PreviewProps {
...
// export function getCustomCaption(values: EventBackgroundPreviewProps, platform: Platform): string {
